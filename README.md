...
* Grab config.txt from [here](https://github.com/raspberrypisig/usb-msd-raspberrypi-multios/raw/master/partition1/config.txt) and replace file on partition 3
...
Same content as partition 1, except for config.txt from [here](https://github.com/raspberrypisig/usb-msd-raspberrypi-multios/raw/master/partition2/config.txt)
